...
| 테이블 | 설명 |
|--------|------|
| movies | 42,917편 (24컬럼: 기본정보 + emotion_tags, mbti_scores, weather_scores 등) |
| genres | 장르 마스터 |
...
PGPASSWORD=recflix123 pg_restore -h localhost -U recflix -d recflix \
  --clean --if-exists --no-owner --no-acl recflix_db.dump
```
