...
| 순서 | 섹션 | 표시 조건 | 데이터 소스 |
|:---:|------|----------|-------------|
| 0 | 🎯 맞춤 추천 (hybrid_row) | 로그인 | Hybrid Score 상위 40개 중 랜덤 10개 |
| 1 | 💜 MBTI 추천 | 로그인 + MBTI | mbti_scores 상위 |
| 2 | 날씨별 추천 | 날씨 선택됨 | weather_scores 상위 |
| 3 | 기분별 추천 (동적) | 항상 | emotion_tags → 기본: relaxed |
| 4 | 🔥 인기 영화 | 항상 | popularity 순 100개 중 랜덤 50개 |
| 5 | ⭐ 높은 평점 | 항상 | vote_average 순 100개 중 랜덤 50개 |
...
| 2026-02-09 | 섹션 순서 재변경: 개인화(MBTI→날씨→기분) → 범용(인기→평점) |
